...
def add_collab(client, collab_folder, email, collab_role='VIEWER'):
    collaboration = collab_folder.add_collaborator(email, CollaborationRole.collab_role)
    print(f"Created a collaboration with {email} on folder {collab_folder.get()['name']}")
...
search_files(client, 'about.html')
